		...
		foreach ( $columns as $column_name => $column_display_name ) {
			...
			<?php } elseif ( 'status' === $column_name ) { ?>
				...
				<a href="<?php echo 'admin.php?page=ManageClients&client_id=' . intval( $website['client_id'] ); ?>"><?php echo esc_html( $website['client_name'] ); ?></a>
					...
					?>
				<td class="mainwp-url-cell"><a href="<?php echo esc_url( $website['url'] ); ?>" class="mainwp-may-hide-referrer open_site_url" target="_blank"><?php echo MainWP_Utility::get_nice_url( $website['url'] ); ?></a></td>
