...
class MainWP_UI {
	...
	public static function render_header_actions() { //phpcs:ignore -- complex method.
		...
		<div class="ui icon top left pointing dropdown button" id="mainwp-help-menu-icon-button">
			...
			<div class="menu">
				<a class="item" id="mainwp-wp-admin-menu-item" href="<?php echo admin_url( 'admin.php?page=Settings' ); ?>" data-inverted="" data-position="bottom right" data-tooltip="<?php esc_attr_e( 'Go to MainWP Settings', 'mainwp' ); ?>">
					<i class="cog icon"></i> <?php esc_html_e( 'Settings', 'mainwp' ); ?></span>
				</a>
				<a class="item" id="mainwp-wp-admin-menu-item" href="<?php echo admin_url( 'admin.php?page=ServerInformation' ); ?>" data-inverted="" data-position="bottom right" data-tooltip="<?php esc_attr_e( 'Go to MainWP Info', 'mainwp' ); ?>">
	...
	public static function render_empty_element_placeholder( $placeholder = '' ) {
		...
		<div class="ui one column grid" style="height:100%">
			<div class="middle aligned center aligned column">
				<img src="/wp-content/plugins/mainwp/assets/images/mainwp-widget-placeholder.png" />
				<?php if ( '' !== $placeholder ) : ?>
