...
class MainWP_UI {
						...
						<div class="content">
							...
							<div class="ui fluid relaxed list">
								...
								<div class="item">
									...
									<a href="<?php echo 'admin.php?page=managesites&scanid=' . intval( $website->id ); ?>"><?php esc_html_e( 'Security Scan', 'mainwp' ); ?></a>
								</div>
								<div class="item">
	...
	public static function render_header_actions() { //phpcs:ignore -- complex method.
			...
			<a class="ui button green <?php echo ( 0 < $sites_count ? '' : 'disabled' ); ?> " id="mainwp-sync-sites" data-inverted="" data-position="bottom right" data-tooltip="<?php esc_attr_e( 'Get fresh data from your child sites.', 'mainwp' ); ?>">
				...
				<span class="mainwp-sync-button-text">
						<?php
							 ...
							 * Filter: mainwp_main_sync_button_text
							 *
							 * Filters the Sync Sites button text.
							 *
							 * @since 4.1
							 */
							echo esc_html( apply_filters( 'mainwp_main_sync_button_text', esc_html__( 'Sync Sites', 'mainwp' ) ) );
						?>
				</span>
			</a>
						<?php
		...
		<div class="ui <?php echo ( empty( $sites_count ) ? 'green' : '' ); ?> buttons" id="mainwp-add-new-buttons">
			...
			<a class="ui button" data-inverted="" data-position="right center" data-tooltip="<?php esc_attr_e( 'Add a new Website to your MainWP Dashboard', 'mainwp' ); ?>" href="<?php echo esc_url( admin_url( 'admin.php?page=managesites&do=new' ) ); ?>"><?php esc_html_e( 'Add', 'mainwp' ); ?></a>
		...
		<div class="ui icon top left pointing dropdown button" id="mainwp-help-menu-icon-button">
			...
			<div class="menu">
				<a class="item" id="mainwp-wp-admin-menu-item" href="<?php echo admin_url( 'index.php' ); ?>" data-inverted="" data-position="bottom right" data-tooltip="<?php esc_attr_e( 'Go to WP Admin', 'mainwp' ); ?>">
	...
	public static function render_page_navigation( $subitems = array(), $name_caller = null ) {
		...
		<div id="mainwp-page-navigation-wrapper">
			<div class="ui  menu stackable mainwp-page-navigation">
		<?php
