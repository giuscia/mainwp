...
class Api_Backups_Admin {
	...
	public function admin_init() {
		...
		if ( isset( $_GET['page'] ) && ( 'ManageApiBackups' === $_GET['page'] || 'ManageSitesApiBackups' === $_GET['page'] || 'SettingsApiBackups' === $_GET['page'] ) ) {
	...
	public static function init_menu() {
		self::$page = add_submenu_page(
			'mainwp_tab',
			esc_html__( 'API Backups - BETA', 'mainwp' ),
			'<div class="mainwp-hidden" id="mainwp-api-backups">' . esc_html__( 'API Backups - BETA', 'mainwp' ) . '</div>',
			'read',
			'ManageApiBackups',
			array(
				Api_Backups_Overview::get_instance(),
