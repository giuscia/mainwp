...
class Api_Backups_Utility {
	 ...
	 * Encrypt data.
	 */
	public function encrypt_api_keys( $data, $siteid = false, $file_key = false, $service_name = '', $default = '' ) {
		if ( is_string( $data ) ) {
	 ...
	 * Encrypt data.
	 */
	public function decrypt_api_keys( $encrypted_data, $default = '' ) {
	 ...
	 * Encrypt data.
	 */
	public function get_api_key( $name, $default = '' ) {
	 ...
	 * Encrypt data.
	 */
	public function get_child_api_key( $website_id, $name, $default = '' ) {
	...
	public function update_child_api_key( $website_id, $name, $value ) {
		...
		$encrypted = json_encode( $this->encrypt_api_keys( $value, $website_id, $key_file, $name ) );
