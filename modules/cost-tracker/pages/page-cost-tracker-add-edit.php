...
class Cost_Tracker_Add_Edit {
	...
	public function render_add_edit_page() {
		...
		$edit_id = isset( $_GET['id'] ) ? intval( $_GET['id'] ) : false;
		...
		<div class="ui alt segment" id="mainwp-module-cost-tracker-add-edit-tab" style="margin-bottom:0px">
			<form id="mainwp-module-cost-tracker-settings-form" method="post" action="admin.php?page=CostTrackerAdd<?php echo $params; ?>" class="ui form">
		...
		<div class="mainwp-main-content">
			<div class="ui segment">
				...
				<div class="ui grid field">
					...
					<div class="ten wide column" data-tooltip="<?php esc_attr_e( 'Enter the Company (Product) name.', 'mainwp' ); ?>" data-inverted="" data-position="top left">
				...
				<div class="ui grid field">
					...
					<div class="ten wide column" data-tooltip="<?php esc_attr_e( 'Enter the URL of the product (optional).', 'mainwp' ); ?>" data-inverted="" data-position="top left">
				...
				<div class="ui grid field">
					...
					<div class="ten wide column" data-tooltip="<?php esc_attr_e( 'Select the type of this cost.', 'mainwp' ); ?>" data-inverted="" data-position="top left">
						<select id="mainwp_module_cost_tracker_edit_payment_type" name="mainwp_module_cost_tracker_edit_payment_type" class="ui dropdown not-auto-init">
							<?php foreach ( $payment_types as $key => $val ) : ?>
								...
								echo '<option value="' . esc_attr( $key ) . '" ' . $_select . '>' . esc_html( $val ) . '</option>';
								?>
							<?php endforeach; ?>
						</select>
					</div>
				...
				<div class="ui grid field hide-if-lifetime-subscription-selected" <?php echo $lifetime_selected ? 'style="display:none;"' : ''; ?>>
					...
					<div class="ten wide column" data-tooltip="<?php esc_attr_e( 'Enter renewal frequency.', 'mainwp' ); ?>" data-inverted="" data-position="top left">
				...
				<div class="ui grid field hide-if-lifetime-subscription-selected" <?php echo $lifetime_selected ? 'style="display:none;"' : ''; ?>>
					<label class="six wide column middle aligned"><?php esc_html_e( 'Next renewal', 'mainwp' ); ?></label>
						<div class="ten wide column" data-inverted="" data-position="top left">
				...
				<div class="ui grid field">
					<label class="six wide column middle aligned"><?php esc_html_e( 'Product type', 'mainwp' ); ?></label>
					<div class="ten wide column" data-tooltip="<?php esc_attr_e( 'Select the product type for this cost.', 'mainwp' ); ?>" data-inverted="" data-position="top left">
						<select id="mainwp_module_cost_tracker_edit_product_type" name="mainwp_module_cost_tracker_edit_product_type" class="ui dropdown">
				...
				<div class="ui grid field">
					...
					<div class="ten wide column" data-tooltip="<?php esc_attr_e( 'Enter the product slug.', 'mainwp' ); ?>" data-inverted="" data-position="top left">
				...
				<div class="ui grid field">
					...
					<div class="ten wide column" data-tooltip="<?php esc_attr_e( 'Select the license type of this cost.', 'mainwp' ); ?>" data-inverted="" data-position="top left">
				...
				<div class="ui grid field">
					...
					<div class="ten wide column" data-tooltip="<?php esc_attr_e( 'Enter Subscription Price.', 'mainwp' ); ?>" data-inverted="" data-position="top left">
				...
				<div class="ui grid field">
					...
					<div class="ten wide column" data-tooltip="<?php esc_attr_e( 'Enter the purchase date.', 'mainwp' ); ?>" data-inverted="" data-position="top left">
						<div class="ui calendar mainwp_datepicker">
							<div class="ui input left icon">
								<i class="calendar icon"></i>
								<input type="text" placeholder="<?php esc_attr_e( 'Select date', 'mainwp' ); ?>" id="mainwp_module_cost_tracker_edit_last_renewal" name="mainwp_module_cost_tracker_edit_last_renewal" value="<?php echo $last_renewal ? MainWP_Utility::format_timestamp( MainWP_Utility::get_timestamp( $last_renewal ) ) : ''; ?>" />
							</div>
						</div>
					</div>
				</div>
				...
				<div class="ui grid field">
					...
					<div class="ten wide column" data-tooltip="<?php esc_attr_e( 'Enter subscription status.', 'mainwp' ); ?>" data-inverted="" data-position="top left">
