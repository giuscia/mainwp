	...
	public static function render_extensions_groups() {
		...
		<div class="ui segment">
			<div class="ui four stackable cards" id="mainwp-extensions-list">
				<?php if ( isset( $_GET['page'] ) && 'Extensions-Mainwp-Backups' === $_GET['page'] ) : ?>
					<div class="ui extension card">
						<div class="content">
							<img class="right floated mini ui image" src="<?php echo MAINWP_PLUGIN_URL . 'assets/images/extensions/placeholder.png'; ?>">
				...
				<?php endif; ?>
				<?php if ( isset( $_GET['page'] ) && 'Extensions-Mainwp-Monitoring' === $_GET['page'] ) : ?>
					<div class="ui extension card">
						<div class="content">
							<img class="right floated mini ui image" src="<?php echo MAINWP_PLUGIN_URL . 'assets/images/extensions/placeholder.png'; ?>">
