...
class MainWP_Site_Actions {
	...
	private static function render_info( $actions_info, $website ) {
		...
		<div id="mainwp-widget-site-actions" class="mainwp-scrolly-overflow">
			...
			<?php else : ?>
				<?php echo MainWP_UI::render_empty_element_placeholder(); ?>
			<?php endif; ?>
		</div>
		<?php
		$params       = array(
		...
		<div class="mainwp-widget-footer">
			<div class="ui two columns stackable grid">
				<div class="middle aligned column">
					<?php if ( $totalRecords ) : ?>
					<a href="admin.php?page=NonMainWPChanges" class="ui button mini fluid green"><?php printf( esc_html__( 'See all %d Non-MainWP Changes', 'mainwp' ), $totalRecords ); ?></a>
					<?php endif; ?>
				</div>
